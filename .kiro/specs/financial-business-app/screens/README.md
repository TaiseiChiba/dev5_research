...
| `SCR014-transaction-final-confirmation.md` | 取引確定画面   | `/transactions/final-confirmation` | 管理者のみ | ✅完了   |
...
本システムでは、ユーザー役割に基づいた画面アクセス制御を実装します。

#### 一般行員（GENERAL_STAFF）

- **アクセス可能**: すべての画面（管理者専用画面を除く）
- **制限事項**:
  - 取引確定画面にはアクセス不可
  - ユーザー管理・システム設定画面にはアクセス不可
